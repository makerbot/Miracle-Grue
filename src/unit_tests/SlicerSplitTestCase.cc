...
void SlicerSplitTestCase::test_m()
{
	...
	segs.push_back(SegmentType(PointType(0.2+x, 0.2+y), PointType(0.2+x, 4.63+y)));
	segs.push_back(SegmentType(PointType(0.2+x, 4.63+y), PointType(0.2+x, 4.8+y)));
	segs.push_back(SegmentType(PointType(0.2+x, 4.8+y), PointType(3.52+x, 4.8+y)));
	segs.push_back(SegmentType(PointType(3.52+x, 4.8+y), PointType(4.8+x, 4.8+y)));
	segs.push_back(SegmentType(PointType(4.8+x, 4.8+y), PointType(4.8+x, 4.63+y)));
	segs.push_back(SegmentType(PointType(4.8+x, 4.63+y), PointType(4.8+x, 0.2+y)));
	segs.push_back(SegmentType(PointType(4.8+x, 0.2+y), PointType(4.63+x, 0.2+y)));
	segs.push_back(SegmentType(PointType(4.63+x, 0.2+y), PointType(0.2+x, 0.2+y)));
	...
	for (unsigned int i=0; i < finalInsets.size(); i++)
	{
		...
		const SegmentType &seg = finalInsets[i];
		Scalar l = seg.length();
...
*/
	...
	segs.push_back(SegmentType(PointType(5.78329+x, 12.6701+y), PointType(5.78329+x, 12.68999+y)));   // 30
	segs.push_back(SegmentType(PointType(5.78329+x, 12.68999+y), PointType(5.78329+x, 12.69005+y)));
	segs.push_back(SegmentType(PointType(5.78329+x, 12.69005+y), PointType(5.78329+x, 12.69008+y)));
	segs.push_back(SegmentType(PointType(5.78329+x, 12.69008+y), PointType(5.78329+x, 12.69352+y)));
	segs.push_back(SegmentType(PointType(5.78329+x, 12.69352+y), PointType(5.78329+x, 14.01863+y)));
	segs.push_back(SegmentType(PointType(5.78329+x, 14.01863+y), PointType(5.78329+x, 14.02035+y)));
	segs.push_back(SegmentType(PointType(5.78329+x, 14.02035+y), PointType(5.78329+x, 14.01971+y))); // 36
	segs.push_back(SegmentType(PointType(5.78329+x, 14.01971+y), PointType(8.25732+x, 14.01971+y)));
	segs.push_back(SegmentType(PointType(8.25732+x, 14.01971+y), PointType(8.26471+x, 14.01971+y)));
	segs.push_back(SegmentType(PointType(8.26471+x, 14.01971+y), PointType(8.26471+x, 14.0186+y)));
	segs.push_back(SegmentType(PointType(8.26471+x, 14.0186+y), PointType(8.26471+x, 12.67359+y)));
	segs.push_back(SegmentType(PointType(8.26471+x, 12.67359+y), PointType(8.26471+x, 12.6701+y)));
	segs.push_back(SegmentType(PointType(8.26471+x, 12.6701+y), PointType(8.26471+x, 12.66993+y)));
	segs.push_back(SegmentType(PointType(8.26471+x, 12.66993+y), PointType(8.26471+x, 12.66771+y)));
	segs.push_back(SegmentType(PointType(8.26471+x, 12.66771+y), PointType(8.37362+x, 12.66771+y)));
	segs.push_back(SegmentType(PointType(8.37362+x, 12.66771+y), PointType(8.374+x, 12.66771+y)));
	segs.push_back(SegmentType(PointType(8.374+x, 12.66771+y), PointType(8.38896+x, 12.66774+y)));
	segs.push_back(SegmentType(PointType(8.38896+x, 12.66774+y), PointType(9.564+x, 12.66971+y)));
	segs.push_back(SegmentType(PointType(9.564+x, 12.66971+y), PointType(9.60304+x, 12.66971+y)));


	segs.push_back(SegmentType(PointType(9.60304+x, 12.66971+y) , PointType(5.78329+x, 12.6701+y)));
...
void SlicerSplitTestCase::test_ultimate_59()
{
	...
	segs.push_back(SegmentType(PointType(22.0, 18.86667), PointType(22.0, 21.65)));
	segs.push_back(SegmentType(PointType(22.0, 21.65), PointType(22.0, 30.0)));
	segs.push_back(SegmentType(PointType(22.0, 30.0), PointType(23.503, 30.0)));
	segs.push_back(SegmentType(PointType(23.503, 30.0), PointType(25.0, 30.0)));
	segs.push_back(SegmentType(PointType(25.0, 30.0), PointType(25.0, 22.24355)));
	segs.push_back(SegmentType(PointType(25.0, 22.24355), PointType(25.0, 21.4125)));
	segs.push_back(SegmentType(PointType(25.0, 21.4125), PointType(25.0, 18.55)));
	segs.push_back(SegmentType(PointType(25.0, 18.55), PointType(25.0, 17.176)));
	segs.push_back(SegmentType(PointType(25.0, 17.176), PointType(25.0, 11.78409)));
	segs.push_back(SegmentType(PointType(25.0, 11.78409), PointType(25.0, 8.14091)));
	segs.push_back(SegmentType(PointType(25.0, 8.14091), PointType(25.0, 4.68947)));
	segs.push_back(SegmentType(PointType(25.0, 4.68947), PointType(25.0, 0.47105)));
	segs.push_back(SegmentType(PointType(25.0, 0.47105), PointType(25.0, -5.0)));
	segs.push_back(SegmentType(PointType(25.0, -5.0), PointType(24.97, -5.0)));
	segs.push_back(SegmentType(PointType(24.97, -5.0), PointType(22.0, -5.0)));
	segs.push_back(SegmentType(PointType(22.0, -5.0), PointType(22.0, 0.775)));
	segs.push_back(SegmentType(PointType(22.0, 0.775), PointType(22.0, 4.95)));
	segs.push_back(SegmentType(PointType(22.0, 4.95), PointType(22.0, 12.10714)));
	segs.push_back(SegmentType(PointType(22.0, 12.10714), PointType(22.0, 14.34375)));
	segs.push_back(SegmentType(PointType(22.0, 14.34375), PointType(22.0, 17.475)));
	segs.push_back(SegmentType(PointType(22.0, 17.475), PointType(22.0, 18.86667)));

	std::vector<SegmentType> segs2;
