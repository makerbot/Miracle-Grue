...
void MglCoreTestCase::testPoint3TypeBasics()
{
	Point3Type foo;
	CPPUNIT_ASSERT( foo.x == 0);
	CPPUNIT_ASSERT( foo.y == 0);
...
void MglCoreTestCase::testTriangleTypeMaths() {

	//Point3Type v0, v1, v2;
	Point3Type v0(0,0,0);
	Point3Type v1(0,0,0);
	Point3Type v2(0,0,0);
	TriangleType foo(v0,v1,v2);
